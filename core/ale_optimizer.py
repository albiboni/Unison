...
def optimize_topography(output_machine: Machine, target_output_rate):
    while maximize_output(output_machine) < target_output_rate:
        ...
        for machine in schedule:
            ...
            if machine[3] > 99.9:
                next_num = max([separate_number(m[0])[1] for m in schedule]) + 1
                the_machine = output_machine.search_machine_by_name(name)
                ...
                break
    return maximize_output(output_machine)
